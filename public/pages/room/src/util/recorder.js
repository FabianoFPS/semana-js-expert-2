class Recorder {
  ...
  _setup() {
    ...
    if (!options) throw new Error(`nome of the codecs: ${commonCodecs.join(',')} are supported`)
  ...
  startRecording() {
    ...
    console.log(`1Creat MediaRecorder ${this.mediaRecorder} with options ${options}`);

    this.mediaRecorder.onstop = (event) => {
      console.log('2Recorder Blobs', this.recordedBlobs);
    }
    ...
    console.log(`3Media Recorded started`, this.mediaRecorder);
